...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.insertNewLine = function () {
        this.maxLines += 1;
        var row = jquery_1.default("<div></div>");
        row.addClass('line');
        row.attr('line-number', this.maxLines.toString());
        var lineNumber = jquery_1.default("<div></div>");
    ...
    Editor.prototype.run = function () {
        ...
        this.editor.click(function (event) {
            // move cursor to text.
            console.log(event);
            var node = jquery_1.default(event.target);
            if (node.hasClass('preserve-whitespace')) {
                // Check which node the selection got to, and put the cursor there.
                var selection = window.getSelection();
                if (selection.isCollapsed) {
                    var node_1 = jquery_1.default(selection.anchorNode);
                    var lineNumber = node_1.attr('line-number');
                    if (lineNumber) {
                        var node_2 = jquery_1.default("div.text[line-number='" + lineNumber + "']");
                        thisEditor.cursor.moveCursorToNodeBoundary(node_2.get(0), true);
                    }
                }
...
},{"./cursor":4,"jquery":1,"tsmonad":2,"voca":3}],6:[function(require,module,exports){
"use strict";
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
